...
module user_top_timepiece_v2 #(
  ...
  ui_in_t watch_in, timer_in, sw_in, alarm_in;
  ui_out_t watch_out, timer_out, sw_out, alarm_out;
  ...
  user_top_alarm_v1 #(
      ...
      .clk(clk),
      .button(alarm_in.button),
      .sw(alarm_in.sw),
      .led(alarm_out.led),
      .hours_disp(alarm_out.hours_disp),
      .minutes_disp(alarm_out.minutes_disp),
      .seconds_disp(alarm_out.seconds_disp),
      .blank_hours(alarm_out.blank_hours),
      .blank_minutes(alarm_out.blank_minutes),
      .blank_seconds(alarm_out.blank_seconds)
  );
